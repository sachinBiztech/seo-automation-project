...
- `seo-automation/outputs/seo-strategist/sprint-approval.json` exists with a `revision_history` array containing
...
Expected output: `seo-automation/outputs/seo-strategist/sprint-plan.json` modified (mtime newer than before step)
